...
class BirdsControllerTest < ActionController::TestCase
  ...
  test "should create bird" do
    assert_difference('Bird.count') do
      post :create, bird: { mugshot: @bird.mugshot, name: @bird.name, variant: @bird.variant, weight: @bird.weight }
    end
  ...
  test "should update bird" do
    patch :update, id: @bird, bird: { mugshot: @bird.mugshot, name: @bird.name, variant: @bird.variant, weight: @bird.weight }
    assert_redirected_to bird_path(assigns(:bird))
  end
